...
function ProfileEdit({ user, editProfile, edit }) {
    const place = useSelector((state) => state.userLogin.city);
    ...
    return (
        <div>
            <div className="text-lime-600 font-semibold text-2xl mb-5">My Profile</div>
            <div>
                <form onSubmit={edit}>
